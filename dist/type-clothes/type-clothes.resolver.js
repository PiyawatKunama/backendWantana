...
let TypeClothesResolver = class TypeClothesResolver {
    ...
    typeClothesByIsDisable(isDisable) {
        return this.typeClothesService.findAllByIsDisable(isDisable);
    }
    async updateTypeClothe(updateTypeClotheInput) {
        await this.typeClothesService.update(updateTypeClotheInput.id, updateTypeClotheInput);
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_type_clothe_input_1.CreateTypeClotheInput]),
    __metadata("design:returntype", void 0)
], TypeClothesResolver.prototype, "createTypeClothe", null);
__decorate([
    (0, graphql_1.Query)(() => [type_clothe_entity_1.TypeClothe], { name: 'typeClothes' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], TypeClothesResolver.prototype, "findAll", null);
__decorate([
    (0, graphql_1.Query)(() => type_clothe_entity_1.TypeClothe, { name: 'typeClothe' }),
    __param(0, (0, graphql_1.Args)('id', { type: () => graphql_1.Int })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], TypeClothesResolver.prototype, "findOne", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TypeClothesResolver.prototype, "typeClothesByIsDisable", null);
__decorate([
    (0, graphql_1.Mutation)(() => type_clothe_entity_1.TypeClothe),
    __param(0, (0, graphql_1.Args)('updateTypeClotheInput')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_type_clothe_input_1.UpdateTypeClotheInput]),
    __metadata("design:returntype", Promise)
], TypeClothesResolver.prototype, "updateTypeClothe", null);
__decorate([
    (0, graphql_1.Mutation)(() => type_clothe_entity_1.TypeClothe),
    __param(0, (0, graphql_1.Args)('id', { type: () => graphql_1.Int })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], TypeClothesResolver.prototype, "removeTypeClothe", null);
