...
TypeClothesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([type_clothe_entity_1.TypeClothe])],
        providers: [type_clothes_resolver_1.TypeClothesResolver, type_clothes_service_1.TypeClothesService],
