...
SortClothesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([sort_clothe_entity_1.SortClothe])],
        providers: [sort_clothes_resolver_1.SortClothesResolver, sort_clothes_service_1.SortClothesService],
